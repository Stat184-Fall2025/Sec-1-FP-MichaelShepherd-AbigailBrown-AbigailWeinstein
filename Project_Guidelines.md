...
| Date | Notes |
|:---|:---|
| Nov. 18/19, 2025 | **Checkpoint #1**: Form Teams and make your team contract (on paper, due by end of class) |
| Nov. 20/21, 2025 | **Checkpoint #2**: Approval of Initial Data and Plan (in MOM, due by end of class) |
| Dec. 1/2, 2025 | **Checkpoint #3**: GitHub Repo Check (in MOM, due by end of class) |
| Dec. 4/5, 2025 | **Checkpoint #4**: Sign up for Work-in-Progress Presentation Slot (in class) |
| Dec. 8-12, 2025 | **Checkpoint #5**: Work-in-Progress Presentations and Peer Feedback |
| Dec. 17, 2025 | **Checkpoint #6**: Submission of Final Report (PDF, Canvas) and Link to Repo (submission comment) |
| Dec. 18, 2025 | **Checkpoint #7**: Submission of Self- & Peer Evaluations |
...
-   [ ] Conduct Exploratory Data Analysis.
    ...
    -   [ ] Create multiple data visualizations (tables and figures) that assist both the team and readers in understanding the data.
        ...
        -   [ ] Each team member should be the main author behind **at least one** professional looking plot/graph.
...
3)  Your data sets/collections should be rich for exploration. That is, there should be multiple attributes (more than 3) for you to explore in your team. We **strongly encourage** your team to look for multiple data sets/collections that you can link together so that the sets complement/supplement each other.
...
6)  Your data **may not** come from or be found on Kaggle. It is your team's responsibility to complete this check. Projects using data from Kaggle will be treated as non-submissions.
...
In the last week of classes (Dec. 8th--Dec. 12th, 2025), each group will give a **short/brief** presentation to the class (<mark>approximately 5 minutes</mark>). In the presentation, each team will share

1)  what they are exploring,
2)  **one (1)** insight they have had so far,and
3)  **one (1)** challenge they have encountered as they work (if any).
...
## Data and Topics {#data-and-topics}
